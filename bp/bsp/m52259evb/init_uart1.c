...
/* SC944D UART1: TeleInfo Linky, 1200 baud, 7 bits, even parity, 1 stop */
const MCF52XX_UART_SERIAL_INIT_STRUCT _bsp_uart1_init = {
   ...
   /* UMR1 Value         */ MCF52XX_UART_UMR1_EVEN_PARITY |
                            MCF52XX_UART_UMR1_7_BITS,
   /* UMR2 Value         */ MCF52XX_UART_UMR2_1_STOP_BIT,
   /* Baud rate          */ BSPCFG_UART1_BAUD_RATE,
   /* Address            */ BSPCFG_UART1_STATION_ADDR
};
