...
/* SC944D UART2: EspionRS debug, 9600 baud, 8N1 */
const MCF52XX_UART_SERIAL_INIT_STRUCT _bsp_uart2_init = {
   /* queue size         */ BSPCFG_UART2_QUEUE_SIZE,
   /* Channel            */ MCF52XX_IO_UART2,
   /* Clock Speed        */ BSP_SYSTEM_CLOCK,
   /* Interrupt Vector   */ BSP_UART2_INT_VECTOR,
   /* Interrupt Level    */ BSP_UART2_INT_LEVEL,
   /* Interrupt Sublevel */ BSP_UART2_INT_SUBLEVEL,
